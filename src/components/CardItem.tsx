...
function CardItem(props: {product: IProduct}) {
    const dispatch = useAppDispatch();

    return(
        <div className="cart__item">
            <div className="cart__item-img">
                <img className="pizza-block__image" src={props.product.thumbnail} alt="Pizza"/>
            </div>
            ...
            <div className="cart__item-remove">
                <div onClick={() => dispatch(removeFromCard(props.product))} className="button button--outline button--circle">
